...
public class LightLocalizer {
	...
	public void doLocalization() {
		...
		robot.advance(-STRAIGHT_SPEED);
		try {
			Thread.sleep((int) (LS_RADIUS * 1000 / STRAIGHT_SPEED));
		} catch (Exception e) {
		}
		...
		try {
			Thread.sleep((int) (70 * 1000 / ROTATION_SPEED));
		} catch (Exception e) {
		}
		oldReading = ls.getLightValue();
		while (ls.getNormalizedLightValue() > 500)
		...
		robot.rotate(-ROTATION_SPEED);
		try {
			Thread.sleep((int) (TURN_ANGLE * 1000 / ROTATION_SPEED));
		} catch (Exception e) {
		}
		...
		robot.advance(-STRAIGHT_SPEED);
		try {
			Thread.sleep((int) (3 * 1000 / STRAIGHT_SPEED));
		} catch (Exception e) {
		}
